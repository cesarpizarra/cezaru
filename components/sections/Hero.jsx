...
const Hero = () => {
  return (
    ...
    >
      <motion.p variants={fade(0.8, 0.3)} className="text-lg mb-4 text-primary">
        Hi there, I am
      </motion.p>
      <motion.h1
      ...
      <motion.h2
        ...
        className="text-xl lg:text-5xl font-bold mb-4 text-whiteSecondary inline-block whitespace-normal"
      >
